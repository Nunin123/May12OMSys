...
Partial Public Class OMSysOrdersDBDataSet
    ...
    Partial Public Class OMSys_OrdersV2DBDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddOMSys_OrdersV2DBRow(ByVal Product_Name As String, ByVal Quantity As Integer, ByVal Total_Price As Decimal, ByVal Address As String, ByVal Contact_Number As String, ByVal Notes As String, ByVal Status As String, ByVal Customer_FirstName As String, ByVal Customer_MiddleName As String, ByVal Customer_LastName As String, ByVal Date_Added As String, ByVal Date_Delivered As String, ByVal Price As Integer) As OMSys_OrdersV2DBRow
            Dim rowOMSys_OrdersV2DBRow As OMSys_OrdersV2DBRow = CType(Me.NewRow,OMSys_OrdersV2DBRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Product_Name, Quantity, Total_Price, Address, Contact_Number, Notes, Status, Customer_FirstName, Customer_MiddleName, Customer_LastName, Date_Added, Date_Delivered, Price}
    ...
    Partial Public Class OMSys_OrdersV2DBRow
        ...
        Public Property Price() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableOMSys_OrdersV2DB.PriceColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Price' in table 'OMSys_OrdersV2DB' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableOMSys_OrdersV2DB.PriceColumn) = value
            End Set
        End Property
        ...
        Public Function IsPriceNull() As Boolean
            Return Me.IsNull(Me.tableOMSys_OrdersV2DB.PriceColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetPriceNull()
            Me(Me.tableOMSys_OrdersV2DB.PriceColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class OMSys_OrdersV2DBTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `OMSys_OrdersV2DB` WHERE ((`ID` = ?) AND ((? = 1 AND `Product_Name` I"& _ 
                ...
                "ate_Delivered` IS NULL) OR (`Date_Delivered` = ?)) AND ((? = 1 AND `Price` IS NU"& _ 
                "LL) OR (`Price` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_ID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "ID", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `OMSys_OrdersV2DB` (`Product_Name`, `Quantity`, `Total_Price`, `Addre"& _ 
                ...
                "me`, `Customer_MiddleName`, `Date_Added`, `Date_Delivered`, `Price`) VALUES (?, "& _ 
                "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `OMSys_OrdersV2DB` SET `Product_Name` = ?, `Quantity` = ?, `Total_Price` ="& _ 
                ...
                " ?, `Date_Delivered` = ?, `Price` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Product"& _ 
                "_Name` IS NULL) OR (`Product_Name` = ?)) AND ((? = 1 AND `Quantity` IS NULL) OR "& _ 
                "(`Quantity` = ?)) AND ((? = 1 AND `Total_Price` IS NULL) OR (`Total_Price` = ?))"& _ 
                " AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Contact"& _ 
                "_Number` IS NULL) OR (`Contact_Number` = ?)) AND ((? = 1 AND `Status` IS NULL) O"& _ 
                "R (`Status` = ?)) AND ((? = 1 AND `Customer_FirstName` IS NULL) OR (`Customer_Fi"& _ 
                "rstName` = ?)) AND ((? = 1 AND `Customer_LastName` IS NULL) OR (`Customer_LastNa"& _ 
                "me` = ?)) AND ((? = 1 AND `Customer_MiddleName` IS NULL) OR (`Customer_MiddleNam"& _ 
                "e` = ?)) AND ((? = 1 AND `Date_Added` IS NULL) OR (`Date_Added` = ?)) AND ((? = "& _ 
                "1 AND `Date_Delivered` IS NULL) OR (`Date_Delivered` = ?)) AND ((? = 1 AND `Pric"& _ 
                "e` IS NULL) OR (`Price` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Product_Name, Quantity, Total_Price, Address, Contact_Number, Notes, S"& _ 
                ...
                "ate_Delivered, Price FROM OMSys_OrdersV2DB"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Product_Name As String, ByVal Original_Quantity As Global.System.Nullable(Of Integer), ByVal Original_Total_Price As Global.System.Nullable(Of Decimal), ByVal Original_Address As String, ByVal Original_Contact_Number As String, ByVal Original_Status As String, ByVal Original_Customer_FirstName As String, ByVal Original_Customer_LastName As String, ByVal Original_Customer_MiddleName As String, ByVal Original_Date_Added As String, ByVal Original_Date_Delivered As String, ByVal Original_Price As Global.System.Nullable(Of Integer)) As Integer
            ...
            If (Original_Price.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(24).Value = CType(Original_Price.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal Product_Name As String, ByVal Quantity As Global.System.Nullable(Of Integer), ByVal Total_Price As Global.System.Nullable(Of Decimal), ByVal Address As String, ByVal Contact_Number As String, ByVal Notes As String, ByVal Status As String, ByVal Customer_FirstName As String, ByVal Customer_LastName As String, ByVal Customer_MiddleName As String, ByVal Date_Added As String, ByVal Date_Delivered As String, ByVal Price As Global.System.Nullable(Of Integer)) As Integer
            If (Product_Name Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
            ...
            If (Price.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(12).Value = CType(Price.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_Date_Delivered As String,  _
                    ByVal Original_Price As Global.System.Nullable(Of Integer)) As Integer
            If (Product_Name Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
            ...
            If (Original_Total_Price.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_Total_Price.Value,Decimal)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(27).Value = CType(Original_Customer_FirstName,String)
            End If
            If (Original_Customer_LastName Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(29).Value = CType(Original_Customer_LastName,String)
            End If
            If (Original_Customer_MiddleName Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(31).Value = CType(Original_Customer_MiddleName,String)
            End If
            If (Original_Date_Added Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(33).Value = CType(Original_Date_Added,String)
            End If
            If (Original_Date_Delivered Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(35).Value = CType(Original_Date_Delivered,String)
            End If
            If (Original_Price.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(36).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(37).Value = CType(Original_Price.Value,Integer)
            Else
